...
const RapportInfo7jours = ({ period }) => {
    ...
    useEffect(() => {
        const fetchClient = async () => {
            try {
                const { data } = await axios.get(`${DOMAIN}/client/count7jours`);
            ...
            try {
                const { data } = await axios.get(`${DOMAIN}/operation/count7jours`);
        ...
        const fetchTraceur = async () => {
            try {
                const { data } = await axios.get(`${DOMAIN}/traceur/count7jours`);
        ...
        const fetchVehicule = async () => {
            try {
                const { data } = await axios.get(`${DOMAIN}/vehicule/count7jours`);
