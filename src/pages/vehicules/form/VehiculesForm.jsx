...
const VehiculesForm = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      setIsLoading(true);
      await axios.post(`${DOMAIN}/vehicule`, { ...data });
    ...
    <>
      ...
      >
        ...
        <div className="modal-data">
          <p><strong>Client ou société:</strong> {client.find(c => c.id_client === data.id_client)?.nom_client}</p>
          <p><strong>Marque:</strong> {marque.find(m => m.id_marque === data.id_marque)?.nom_marque}</p>
